Hanami.app.register_provider :persistence, namespace: true do
  ...
  start do
    ...
    register "repos.follow", Chirper::Persistence::Repos::Follow.new(container: container)
    register "repos.status", Chirper::Persistence::Repos::Status.new(container: container)
    register "repos.account", Chirper::Persistence::Repos::Account.new(container: container)
  end
end
